...
let submitButtonTwo = document.querySelector('#submit-button-forward');
let stepTwoSubmitButton = document.querySelector('#step-2-submit');
let jsGetForwardUrl = document.querySelector('.js-get-forward-url');
let forwardUrl = jsGetForwardUrl.dataset.getForwardUrl;
